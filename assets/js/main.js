...
tabs.forEach((tab) => {
  tab.addEventListener('click', () => {
    ...
    // Active the tab & corresponding content
...
const scrollActive = () => {
  // We gey position by scrolling down
  const scrollY = window.scrollY

  sections.forEach(section => {
    const id = section.id, // id of each section
      top = section.offsetTop - 50, // Distance from top of edge
      height = section.getAttribute('id'), // Element height
